 ...
 */
final class Version20250112191857 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE article (id SERIAL NOT NULL, language_id INT NOT NULL, author_id INT NOT NULL, title VARCHAR(255) NOT NULL, content VARCHAR(10000) NOT NULL, created_date_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, update_date_at DATE DEFAULT NULL, published BOOLEAN NOT NULL, slug VARCHAR(100) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_23A0E6682F1BAF4 ON article (language_id)');
        $this->addSql('CREATE INDEX IDX_23A0E66F675F31B ON article (author_id)');
        $this->addSql('COMMENT ON COLUMN article.created_date_at IS \'(DC2Type:datetime_immutable)\'');
        ...
        $this->addSql('CREATE TABLE language (id SERIAL NOT NULL, code VARCHAR(5) NOT NULL, label VARCHAR(100) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE review (id SERIAL NOT NULL, article_id INT NOT NULL, author_id INT NOT NULL, content VARCHAR(1000) NOT NULL, created_date_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('COMMENT ON COLUMN review.created_date_at IS \'(DC2Type:datetime_immutable)\'');
        $this->addSql('CREATE TABLE "user" (id SERIAL NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, username VARCHAR(100) NOT NULL, reset_token VARCHAR(255) DEFAULT NULL, created_date_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, is_verified BOOLEAN NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL ON "user" (email)');
        $this->addSql('COMMENT ON COLUMN "user".created_date_at IS \'(DC2Type:datetime_immutable)\'');
